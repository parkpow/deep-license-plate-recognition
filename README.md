...
`python plate_recognition.py --api MY_API_KEY --region "fr" "/path/to/car.jpg"`
...
`python plate_recognition.py --api MY_API_KEY "/path/to/car1.jpg" "/path/to/car2.jpg" "/path/to/car3.jpg"`
...
`python plate_recognition.py --api MY_API_KEY --url http://localhost:8080 /path/to/vehicle.jpg`
