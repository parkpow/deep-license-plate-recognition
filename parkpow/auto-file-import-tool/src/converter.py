...
HEADERS = [
    "timezone", "created_date", "created_time", "license_plate", "region",
    "make", "model", "color", "type", "payment_status",
    "field1", "field2", "field3", "field4", "field5", "field6", "Vehicle Tags"
]
...
def process_input_file(input_filename: str) -> tuple[list, set]:
    ...
    try:
        ...
        logger.info(f"Finished processing input file. Found {len(license_plates_in_file)} unique license plates.")
