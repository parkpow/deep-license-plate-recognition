  ...
  return (
    <div className="p-4 space-y-6 h-full overflow-y-auto">
      <Card>
        <CardHeader>
          <CardTitle>
            Webhook Security <span className="text-red-500">*</span>
          </CardTitle>
          <CardDescription>
            Protect your webhook endpoint with a secret token. This is mandatory for all
            API requests. Include this token in the `Authorization` header of your
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Example of how to trigger a relay using `curl`.
          </CardDescription>
        </CardHeader>
