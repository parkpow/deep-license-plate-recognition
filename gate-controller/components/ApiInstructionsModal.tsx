        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
          <div className="md:col-span-2">
            ...
            <p className="text-xs text-gray-500 mb-1">
              The body of your POST request must be a JSON object with one of the
            ...
            <p className="text-xs text-gray-500 mb-1">
              The <code>toggle</code> parameter inverts the action after a{" "}
              <code>period</code> (in milliseconds).
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
              <CodeBlock
                payload={{
            ...
            {isMultiChannel && relay.channels && relay.channels > 1 && (
              <p className="text-xs text-gray-500 mt-1">
                For this relay, you can change the <code>channel</code> value from 1 to{" "}
                {relay.channels}.
              </p>
            )}
          </div>
