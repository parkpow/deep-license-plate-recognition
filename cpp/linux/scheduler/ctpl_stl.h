...
class thread_pool {
 public:
  ...
  // run the user's function that excepts argument int - id of the running thread. returned value is
  // templatized operator returns std::future, where the user can get the result and rethrow the
  // catched exceptins
  template <typename F>
